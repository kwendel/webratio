...
-- Shopping Cart_Product [rel2]
create table "public"."shopping_cart_product" (
   "shopping_cart_oid"  int4 not null,
   "product_oid"  int4 not null,
  primary key ("shopping_cart_oid", "product_oid")
);
alter table "public"."shopping_cart_product"   add constraint fk_shopping_cart_product_shopp foreign key ("shopping_cart_oid") references "public"."shopping_cart" ("oid");
alter table "public"."shopping_cart_product"   add constraint fk_shopping_cart_product_produ foreign key ("product_oid") references "public"."product" ("oid");


-- Shopping Cart_User [rel3]
alter table "public"."shopping_cart"  add column  "user_oid"  int4;
alter table "public"."shopping_cart"   add constraint fk_shopping_cart_user foreign key ("user_oid") references "public"."user" ("oid");
